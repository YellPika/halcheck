...
\begin{frame}[t,fragile]{\halcheck{} --- Design --- Core}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{itemize}
      ...
      \item<10->[\alert<10>{\textbullet}] \cppinline{std::optional<int> gen::shrink(int)}
    \end{itemize}
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{overprint}
      ...
      \begin{cppcode}
        ...
        x += |\only<1>{gen::next()}\only<2-6>{\textcolor{orange}{true}}\only<7>{\textcolor{red}{false}}| ? 1 : 0;
      \end{cppcode}
      ...
      \begin{cppcode}
        ...
        x += |\only<8>{gen::next()}\only<9->{\textcolor{orange}{true}}| ? 1 : 0;
      \end{cppcode}
    \end{overprint}
    ...
    \begin{overprint}
      ...
      \begin{itemize}
        ...
        \item<4-> Final call to \cppinline{gen::next} returns \texttt{\footnotesize\color{orange}{true}}.
      \end{itemize}
