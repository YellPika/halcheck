    ...
    \begin{columns}[T]
      ...
      \begin{onlyenv}<.(1)-.(2)>
        \begin{itemize}
          ...
          \item<.(2)-> Problem: \mintinline{c++}{gen::arbitrary<size_t>} is uniformly distributed --- high chance of generating \emph{billions of GBs}.
        \end{itemize}
      \end{onlyenv}
...
\begin{frame}[fragile]{\halcheck{} --- Design --- \mintinline{c++}{gen::shrink}}
  \begin{center}
